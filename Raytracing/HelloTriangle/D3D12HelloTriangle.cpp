...
{ 
    ...
    Vertex planeVertices[] = { {{-1.5f, -.8f, 01.5f}, {1.0f, 1.0f, 1.0f, 1.0f}},  // 0 
    ...
    memcpy(pVertexDataBegin, planeVertices, sizeof(planeVertices)); m_planeBuffer->Unmap(0, nullptr);
    // Initialize the vertex buffer view. 
...
void D3D12HelloTriangle::CreateCameraBuffer() 
{
    ...
    m_cameraBuffer = nv_helpers_dx12::CreateBuffer(
        m_device.Get(), m_cameraBufferSize,
